...
```
    ...
    python legged_gym/scripts/train.py --task=a1 --headless --sim_device=cuda:0 
    python legged_gym/legged_gym/scripts/train.py --task=a1 --headless --sim_device=cuda:0 --max_iteration 10000 --run_name
```